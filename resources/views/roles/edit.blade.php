            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="bi bi-pencil"></i> Edit Peran: {{ $role->name }}
                    </h5>
                </div>
                <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($permissions->isEmpty())
                                        <div class="alert alert-info">
                                            <i class="bi bi-info-circle"></i> Tidak ada izin yang tersedia. 
                                            <a href="{{ route('permissions.create') }}">Buat izin terlebih dahulu</a>.
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-warning">
                                        <i class="bi bi-check-circle"></i> Update Peran
                                    </button>
                                </div>
                            </div>
                        </div>
